      ...
      <mdb-col md="12">
        <mdb-card cascade narrow class="mt-5">
          <mdb-view class="gradient-card-header blue darken-2">
            ...
            <a href="http://gbcsystem-ice-wolf.c9users.io:8082/classificationmodel" target="_blank"  class="text-white"><u><b>View Classification Model</b></u></a>
          </mdb-view>
...
export default {
  ...
  methods: 
  {
    ...
    {
      this.$http.get('http://gbcsystem-ice-wolf.c9users.io:8082/categorykeywords').then
      (function(data){
