...
keys['sport']=['Coaching','Coaching','captain','coach','Racing','winning','champion','match','game','tournament','win','Cycling',"sport","nfl",'nba','football','basketball','boxing','tennis','cricket','olynmpic','athletic','swimming','cycling']
