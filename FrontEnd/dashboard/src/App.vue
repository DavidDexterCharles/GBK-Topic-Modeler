<template>
  <div class="flexible-content">
    ...
    <mdb-navbar class="flexible-navbar white" light position="top" scrolling>
      <mdb-navbar-brand href="https://mdbootstrap.com/docs/vue/" target="_blank">GBK</mdb-navbar-brand>
      <mdb-navbar-toggler>
        <!--<mdb-accordion>-->
        <mdb-navbar-nav left>
          <mdb-nav-item to="/"  waves-fixed  @click.native="activeItem = 1" :action="true" :class="activeItem === 1 && 'active'" >Models</mdb-nav-item>
          <mdb-nav-item to="/classifiers"  waves-fixed  @click.native="activeItem = 2" :action="true" :class="activeItem === 2 && 'active'" >Classifiers</mdb-nav-item>
          <mdb-nav-item to="/dashboard"  waves-fixed  @click.native="activeItem = 7" :action="true" :class="activeItem === 7 && 'active'">Dashboard</mdb-nav-item>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <mdb-list-group class="list-group-flush">
        <router-link to="/models" @click.native="activeItem = 1">
          <mdb-list-group-item :action="true" :class="activeItem === 1 && 'active'"><mdb-icon icon="coins" class="mr-3"/>Models</mdb-list-group-item>
        </router-link>
        <router-link to="/classifiers" @click.native="activeItem = 2">
          <mdb-list-group-item :action="true" :class="activeItem === 2 && 'active'"><mdb-icon icon="lemon" class="mr-3"/>Classifiers</mdb-list-group-item>
        </router-link>
        <router-link to="/dashboard" @click.native="activeItem = 7">
          <mdb-list-group-item :action="true" :class="activeItem === 7 && 'active'"><mdb-icon icon="pie-chart" class="mr-3"/>Dashboard</mdb-list-group-item>
        </router-link>
        ...
        <router-link to="/404" @click.native="activeItem = 5">
         ...
         <router-link to="/profile" @click.native="activeItem = 6">
          <mdb-list-group-item :action="true" :class="activeItem === 6 && 'active'"><mdb-icon icon="user" class="mr-3"/>Profile</mdb-list-group-item>
        </router-link>
      </mdb-list-group>
    </div>
    <!-- /Sidebar  -->
    <!--style="calc(100vh - 52px)"-->
    <!--</br></br>-->
    <main>
      <div class="mt-5 p-5">
...
<script>
import { mdbAccordion, mdbView, mdbMask, mdbContainer, mdbNavbar, mdbNavbarBrand, mdbNavItem, mdbNavbarNav, mdbNavbarToggler, mdbBtn, mdbIcon, mdbListGroup, mdbListGroupItem, mdbCardBody, mdbFooter, waves } from 'mdbvue'
