      ...
      <mdb-list-group class="list-group-flush">
        ...
        <router-link to="/404" @click.native="activeItem = 5">
         ...
         <router-link to="/test" @click.native="activeItem = 6">
          <mdb-list-group-item :action="true" :class="activeItem === 6 && 'active'"><mdb-icon icon="lemon" class="mr-3"/>Test Option</mdb-list-group-item>
        </router-link>
         <router-link to="/models" @click.native="activeItem = 7">
          <mdb-list-group-item :action="true" :class="activeItem === 7 && 'active'"><mdb-icon icon="coins" class="mr-3"/>Models</mdb-list-group-item>
        </router-link>
      </mdb-list-group>
    </div>
    <!-- /Sidebar  -->
